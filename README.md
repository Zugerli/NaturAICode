...
Multimodal: La visión, el audio y el razonamiento son funciones básicas, no librerías complejas.
...
// Programando en español
    ...
    usar cerebro(potente)
    entrenar_con("mi_rostro.jpg", etiqueta: "Dueño")

    mientras(camara.detecte_movimiento):
